...
public class PortfolioRecommendationDTO {
    ...
    private com.example.dto.PortfolioProgressDTO progress;
    private List<com.example.dto.TargetAllocationDTO> targetAllocations;
    private List<com.example.dto.TargetAllocationDTO> currentAllocations;
    private List<com.example.dto.AllocationDriftDTO> allocationDrifts;
    private List<com.example.dto.RecommendationItemDTO> recommendations;
    ...
    public com.example.dto.PortfolioProgressDTO getProgress() {
        return progress;
    }
    ...
    public List<com.example.dto.TargetAllocationDTO> getTargetAllocations() {
        return targetAllocations;
    }

    public void setTargetAllocations(List<com.example.dto.TargetAllocationDTO> targetAllocations) {
        this.targetAllocations = targetAllocations;
    }

    public List<com.example.dto.TargetAllocationDTO> getCurrentAllocations() {
    ...
    public List<com.example.dto.AllocationDriftDTO> getAllocationDrifts() {
    ...
    public List<com.example.dto.RecommendationItemDTO> getRecommendations() {
